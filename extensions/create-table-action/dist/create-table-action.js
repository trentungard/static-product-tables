(() => {
  ...
  // node_modules/@shopify/ui-extensions/build/esm/surfaces/admin/components/Pressable/Pressable.mjs
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/admin/components/Pressable/Pressable.mjs
  ...
  // extensions/create-table-action/hooks/useProductData.tsx
  ...
  var ProductDataContext = (0, import_react18.createContext)(initialProductData);
  var productDataReducer = (state, action) => {
    const { indexOfData, index, type, value, key } = action;
    switch (type) {
      case "update_column_data": {
        if (!indexOfData || !index || !key)
          throw Error("Must pass an indexOfData, index and key to Update Column Data");
        const localCopy = __spreadValues({}, state);
        const custom_table_metafield = localCopy.metafields.edges[indexOfData].node.value;
        custom_table_metafield.data[index][key] = value;
        localCopy.metafields.edges[index].node.value = custom_table_metafield;
        return localCopy;
      }
      case "update_column_header": {
        if (!indexOfData || !key || !value)
          throw Error("Must pass an indexOfData, value and key to Update Column Header");
        const localCopy = __spreadValues({}, state);
        const custom_table_metafield = state.metafields.edges[indexOfData].node.value;
        let oldHeader;
        const newColumns = custom_table_metafield.columns.map((header, i) => {
          if (i == key) {
            oldHeader = header;
          }
      ...
      case "add_column": {
        ...
        localCopy.metafields.edges[index].node.value = __spreadValues({}, custom_table_metafield);
        return localCopy;
      }
      case "add_row": {
        const localCopy = __spreadValues({}, state);
      ...
      case "remove_row": {
        ...
        const new_rows = localCopy.metafields.edges[indexOfData].node.value.data.filter((row, index2) => index2 !== value);
      ...
      case "update_product_data": {
        return __spreadValues(__spreadValues({}, state), value);
      }
    }
  };
  var useProductData = () => (0, import_react18.useContext)(ProductDataContext);
  var ProductDataProvider = ({ children }) => {
    const [productData, dispatch] = (0, import_react18.useReducer)(productDataReducer, initialProductData);
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ProductDataContext.Provider, { value: { productData, dispatch }, children });
  };

  // extensions/create-table-action/src/BaseInterface.tsx
  var import_react21 = __toESM(require_react());

  // extensions/create-table-action/src/CustomTable.tsx
  var import_react20 = __toESM(require_react());

  // extensions/create-table-action/hooks/useAppData.tsx
  ...
  var AppDataContext = (0, import_react19.createContext)(initialAppState);
  var AppDataProvider = ({ children }) => {
    const [state, dispatch] = (0, import_react19.useReducer)(appDataReducer, initialAppState);
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(AppDataContext.Provider, { value: { state, dispatch }, children });
  };
  var useAppData = () => {
    const context = (0, import_react19.useContext)(AppDataContext);
    if (context === void 0) {
  ...
  var CustomTable = () => {
    ...
    const [editingColumn, setEditingColumn] = (0, import_react20.useState)({ name: void 0, newName: void 0 });
    const { indexOfData } = appData;
    const tableData = (0, import_react20.useMemo)(() => productData.metafields.edges.find((metafield) => metafield.node.namespace === "custom_table_relationship"), [productData]);
    (0, import_react20.useEffect)(() => {
      if (!tableData || !tableData.node)
        return void 0;
      const indexOfData2 = productData.metafields.edges.findIndex((value) => value.node.namespace == "custom_table_relationship");
      appDataDispatch({ type: "set_index_of_data", value: indexOfData2 });
    }, [productData]);
    console.log("in custom table", appData.indexOfData, rows, tableData);
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(InlineStack2, { gap: "400", columns: 5, children: columns.map((header, i) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(InlineStack2, { blockAlignment: "center", children: [
        editingColumn.name == header ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TextField2, { value: editingColumn.newName, onChange: (value) => setEditingColumn((state) => __spreadProps(__spreadValues({}, state), { newName: value })) }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Heading2, { children: header.charAt(0).toUpperCase() + header.slice(1) }),
        editingColumn.name == header ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Pressable2, { onClick: () => setEditingColumn({ name: void 0, newName: void 0 }), children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Icon2, { name: "CircleCancelMajor" }) }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Pressable2, { onClick: () => productDataDispatch({
          type: "remove_column",
          key: header,
          indexOfData
        }), children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Icon2, { name: "CircleMinusMajor" }) }),
        editingColumn.name == header ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          Pressable2,
          {
            onClick: () => {
              productDataDispatch({
              ...
              setEditingColumn({ name: void 0, newName: void 0 });
            },
            children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Icon2, { name: "CircleTickMajor" })
          }
        ) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Pressable2, { onClick: () => setEditingColumn({ name: header, newName: void 0 }), children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Icon2, { name: "EditMajor" }) })
      ] }, i)) }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Box2, { children: columns && rows && rows.map(
        (row, rowIndex) => {
          return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(InlineStack2, { gap: "400", columns: columns ? columns.length : 0, children: [
            columns.map((header, columnIndex) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
              TextField2,
              {
                value: row[header],
            ...
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Pressable2, { onClick: () => {
            ...
            }, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Icon2, { name: "CircleCancelMajor" }) })
          ] }, rowIndex);
        }
      ) })
    ] });
  ...
  // extensions/create-table-action/clients/gql/index.ts
  ...
  // extensions/create-table-action/clients/gql/ProductMutations.ts
  function updateCustomTableMetafields(id, metafields) {
    return __async(this, null, function* () {
  ...
  function initializeCustomTableMetafields(id) {
    return __async(this, null, function* () {
      return yield makeGraphQLQuery(
        `mutation UpdateProduct($productId: ID!, $metafields: [MetafieldInput!] ) {
        productUpdate(input: { id: $productId, metafields: $metafields  }) {
  ...
  // extensions/create-table-action/utils/parseProductData.ts
  var parseProductData = (productData, stringify = false) => {
      ...
      if (localCopy.metafields.edges[x].node.namespace === "custom_table_relationship") {
        if (stringify) {
          ...
          while (typeof localCopy.metafields.edges[x].node.value === "string") {
            localCopy.metafields.edges[x].node.value = JSON.parse(localCopy.metafields.edges[x].node.value);
          }
        }
      }
    }
  ...
  // extensions/create-table-action/clients/gql/ProductQueries.ts
  function getProductMetafieldData(id) {
    return __async(this, null, function* () {
      return yield makeGraphQLQuery(
        `query Product($id: ID!) {
        product(id: $id) {
  ...
  // extensions/create-table-action/config/index.ts
  var config = {
  ...
  var BaseInterface = () => {
    ...
    const [productQueryComplete, setProductQueryComplete] = (0, import_react21.useState)(false);
    const { productData, dispatch } = useProductData();
    const { state: appData } = useAppData();
    const [customTableExists, setCustomTableExists] = (0, import_react21.useState)(false);
    ...
    (0, import_react21.useEffect)(() => {
      (function getProductInfo() {
        return __async(this, null, function* () {
          ...
          const { data: data2 } = yield getProductMetafieldData(productId);
          const parsedProductData = parseProductData(data2.product);
    ...
    const onSave = () => __async(void 0, null, function* () {
      const data2 = indexOfData !== -1 ? parseProductData(productData, true).metafields.edges.map((row) => row.node) : dummyMetafieldData;
      const filteredData = indexOfData !== -1 ? data2.map((row) => ({
        id: row.id,
        value: row.value
      })) : data2;
      yield updateCustomTableMetafields(productId, filteredData);
    });
    const createEmptyTable = () => __async(void 0, null, function* () {
      try {
        const data2 = yield initializeCustomTableMetafields(productId);
      } catch (e) {
        console.log("error", e);
      }
    });
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
      AdminAction2,
      {
        primaryAction: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          Button2,
          {
            onPress: () => {
              close();
        ...
        secondaryAction: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          Button2,
          {
            onPress: () => {
              close();
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Text2, { fontWeight: "bold", children: "If you'd like to render a table for this product, please enter it here" }),
          customTableExists ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(CustomTable, {}) : /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Text2, { children: "To create a Static Table for this product, " }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Button2, { onPress: createEmptyTable, children: "click here!" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(InlineStack2, { gap: "400", columns: 3, children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Button2, { onClick: () => {
              console.log("hhsdhfs", indexOfData, appData);
              dispatch({ type: "add_row", indexOfData, value: "" });
            }, children: "New Row" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Button2, { onClick: () => dispatch({ type: "add_column", indexOfData, value: "" }), children: "New Column" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Button2, { onClick: onSave, children: "Save Table" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Checkbox2, { checked: showStaticTable || false, children: "Show Table?" })
          ] })
        ]
      }
    );
  ...
  // extensions/create-table-action/src/ActionExtension.tsx
  var import_jsx_runtime8 = __toESM(require_jsx_runtime());
  var ActionExtension_default = reactExtension(config.target, () => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(App, {}));
  function App() {
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ProductDataProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(AppDataProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(BaseInterface, {}) }) });
  }
})();
